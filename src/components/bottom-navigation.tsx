...
const BottomNavigation = () => {
  return (
    <div className="flex justify-between bg-zinc-800/70 backdrop-blur-md px-6 text-secondary shadow-md fixed w-full max-w-sm rounded-md bottom-4 left-1/2 transform -translate-x-1/2 z-50 py-4">
